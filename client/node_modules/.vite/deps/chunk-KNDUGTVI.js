...
var ReactiveElement = class extends HTMLElement {
  ...
  removeController(controller) {
    var _a4;
    (_a4 = this.__controllers) == null ? void 0 : _a4.splice(this.__controllers.indexOf(controller) >>> 0, 1);
  }
  /**
...
function query(selector, cache) {
  return (protoOrTarget, nameOrContext, descriptor) => {
    const doQuery = (el) => {
      var _a4;
      return ((_a4 = el.renderRoot) == null ? void 0 : _a4.querySelector(selector)) ?? null;
    };
    if (cache) {
...
lit-html/development/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KNDUGTVI.js.map
